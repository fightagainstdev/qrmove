...
import { audioHandle, initializeAudio, sound, toggleAudio } from './audio/audio.js';
...
import { con, keyboard, pointer } from './setup.js';
import { duckPhaseMap, duckState, oscillatorPhaseMap, oscillatorState } from './state.js';
let level;
try {
